(function(g){function f(b){if(d[b])return d[b].exports;var c=d[b]={i:b,l:!1,exports:{}};g[b].call(c.exports,c,c.exports,f);c.l=!0;return c.exports}var d={};f.m=g;f.c=d;f.d=function(b,c,a){f.o(b,c)||Object.defineProperty(b,c,{enumerable:!0,get:a})};f.r=function(b){"undefined"!==typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(b,Symbol.toStringTag,{value:"Module"});Object.defineProperty(b,"__esModule",{value:!0})};f.t=function(b,c){c&1&&(b=f(b));if(c&8||c&4&&"object"===typeof b&&b&&b.__esModule)return b;
var a=Object.create(null);f.r(a);Object.defineProperty(a,"default",{enumerable:!0,value:b});if(c&2&&"string"!=typeof b)for(var e in b)f.d(a,e,function(h){return b[h]}.bind(null,e));return a};f.n=function(b){var c=b&&b.__esModule?function(){return b["default"]}:function(){return b};f.d(c,"a",c);return c};f.o=function(b,c){return Object.prototype.hasOwnProperty.call(b,c)};f.p="";return f(f.s=3)})({"+B8m":function(g,f){var d=wp.media.view.Settings.AttachmentDisplay;f=d.extend({className:"embed-media-settings",
template:wp.template("embed-image-settings"),initialize:function(){d.prototype.initialize.apply(this,arguments);this.listenTo(this.model,"change:url",this.updateImage)},updateImage:function(){this.$("img").attr("src",this.model.get("url"))}});g.exports=f},"+mQJ":function(g,f){var d=wp.media.View,b=jQuery,c=wp.media.view.l10n;f=d.extend({tagName:"span",className:"embed-url",events:{input:"url"},initialize:function(){this.$input=b('<input id="embed-url-field" type="url" />').attr("aria-label",c.insertFromUrlTitle).val(this.model.get("url"));
this.input=this.$input[0];this.spinner=b('<span class="spinner" />')[0];this.$el.append([this.input,this.spinner]);this.listenTo(this.model,"change:url",this.render);this.model.get("url")&&_.delay(_.bind(function(){this.model.trigger("change:url")},this),500)},render:function(){if(!this.$input.is(":focus"))return this.input.value=this.model.get("url")||"http://",d.prototype.render.apply(this,arguments),this},url:function(a){this.model.set("url",(a.target.value||"").trim())}});g.exports=f},"04Ix":function(g,
f){var d=wp.i18n._n,b=wp.i18n.sprintf;f=wp.media.View.extend({tagName:"div",className:"media-selection",template:wp.template("media-selection"),events:{"click .edit-selection":"edit","click .clear-selection":"clear"},initialize:function(){_.defaults(this.options,{editable:!1,clearable:!0});this.attachments=new wp.media.view.Attachments.Selection({controller:this.controller,collection:this.collection,selection:this.collection,model:new Backbone.Model});this.views.set(".selection-view",this.attachments);
...
c=b.get("library"),a=b.get("selection");_.each(this._views,function(e){if(e.model&&e.options&&e.options.requires){var h=e.options.requires,k=!1;a&&a.models&&(k=_.some(a.models,function(l){return!0===l.get("uploading")}));h.selection&&a&&!a.length?k=!0:h.library&&c&&!c.length&&(k=!0);e.model.set("disabled",k)}})}});g.exports=f},"2jku":function(g,f){f=wp.media.view.Attachment.extend({buttons:{check:!0}});g.exports=f},3:function(g,f,d){g.exports=d("tg/Y")},"3nJM":function(g,f){var d=jQuery;f=wp.media.View.extend({events:{keydown:"focusManagementMode"},
...
g.exports=f},"72mI":function(g,f){var d=wp.media.View,b=wp.media.view.settings.mediaTrash,c=wp.media.view.l10n,a=jQuery,e=wp.media.view.settings.infiniteScrolling,h=wp.i18n.__,k=wp.i18n.sprintf;f=d.extend({tagName:"div",className:"attachments-browser",initialize:function(){_.defaults(this.options,{filters:!1,search:!0,date:!0,display:!1,sidebar:!0,AttachmentView:wp.media.view.Attachment.Library});this.controller.on("toggle:upload:attachment",this.toggleUploader,this);this.controller.on("edit:selection",
...
disposeSingle:function(){var l=this.sidebar;l.unset("details");l.unset("compat");l.unset("display");l.$el.removeClass("visible")}});g.exports=f},"76BF":function(g,f){f=wp.media.view.Settings.extend({className:"collection-settings playlist-settings",template:wp.template("playlist-settings")});g.exports=f},"7Bpz":function(g,f){var d=wp.media.View;f=d.extend({tagName:"div",className:"uploader-inline",template:wp.template("uploader-inline"),events:{"click .close":"hide"},initialize:function(){_.defaults(this.options,
...
this.controller.$uploaderToggler.attr("aria-expanded","false").trigger("focus")}});g.exports=f},"99yY":function(g,f){var d=wp.media.controller.Library,b=wp.media.view.l10n;f=d.extend({defaults:{id:"gallery-edit",title:b.editGalleryTitle,multiple:!1,searchable:!1,sortable:!0,date:!1,display:!1,content:"browse",toolbar:"gallery-edit",describe:!0,displaySettings:!0,dragInfo:!0,idealColumnWidth:170,editing:!1,priority:60,syncSelection:!1},initialize:function(){this.get("library")||this.set("library",
...
editAttachment:function(c){var a=this.controller.states.get("edit-image");window.imageEdit&&a&&(c.preventDefault(),a.set("image",this.model.attachment),this.controller.setState("edit-image"))},replaceAttachment:function(c){c.preventDefault();this.controller.setState("replace-image")}});g.exports=f},GXkx:function(g,f){var d=wp.media.View,b=wp.media.view.l10n,c=jQuery;f=d.extend({tagName:"div",className:"uploader-editor",template:wp.template("uploader-editor"),localDrag:!1,overContainer:!1,overDropzone:!1,
...
if(""!==a&&-1!==a){var e=d.get(a);e.fetch()}c.reset(e?[e]:[])}});g.exports=f},IgEq:function(g,f){var d=wp.media.view.Toolbar,b=wp.media.view.l10n;f=d.extend({initialize:function(){var c=this.options;_.bindAll(this,"clickSelect");_.defaults(c,{event:"select",state:!1,reset:!0,close:!0,text:b.select,requires:{selection:!0}});c.items=_.defaults(c.items||{},{select:{style:"primary",text:c.text,priority:80,click:this.clickSelect,requires:c.requires}});d.prototype.initialize.apply(this,arguments)},clickSelect:function(){var c=
this.options,a=this.controller;c.close&&a.close();c.event&&a.state().trigger(c.event);c.state&&a.setState(c.state);c.reset&&a.reset()}});g.exports=f},IkWq:function(g,f){var d=wp.media.controller.State;f=d.extend({defaults:_.defaults({id:"image-details",title:wp.media.view.l10n.imageDetailsTitle,content:"image-details",menu:!1,router:!1,toolbar:"image-details",editing:!1,priority:60},wp.media.controller.Library.prototype.defaults),initialize:function(b){this.image=b.image;d.prototype.initialize.apply(this,
arguments)},activate:function(){this.frame.modal.$el.addClass("image-details")}});g.exports=f},JecU:function(g,f){var d=jQuery;f=wp.media.view.Settings.extend({className:"embed-link-settings",template:wp.template("embed-link-settings"),initialize:function(){this.listenTo(this.model,"change:url",this.updateoEmbed)},updateoEmbed:_.debounce(function(){var b=this.model.get("url");this.$(".embed-container").hide().find(".embed-preview").empty();this.$(".setting").hide();b&&(11>b.length||!b.match(/^http(s)?:\/\//))||
...
""}})}).fail(this.renderFail))},renderFail:function(b,c){"abort"!==c&&this.$(".link-text").show()},renderoEmbed:function(b){(b=b&&b.data&&b.data.body||"")?this.$(".embed-container").show().find(".embed-preview").html(b):this.renderFail()}});g.exports=f},Ju2C:function(g,f){var d=wp.media.view.PriorityList;f=d.extend({tagName:"div",className:"media-menu",property:"state",ItemView:wp.media.view.MenuItem,region:"menu",attributes:{role:"tablist","aria-orientation":"horizontal"},initialize:function(){this._views=
...
show:function(b){(b=this.get(b))&&b.$el.removeClass("hidden")}});g.exports=f},KerO:function(g,f){var d=wp.media.view.l10n;f=wp.media.view.AttachmentFilters.extend({createFilters:function(){var b={},c=window.userSettings?parseInt(window.userSettings.uid,10):0;_.each(wp.media.view.settings.mimeTypes||{},function(a,e){b[e]={text:a,props:{status:null,type:e,uploadedTo:null,orderby:"date",order:"DESC",author:null}}});b.all={text:d.allMediaItems,props:{status:null,type:null,uploadedTo:null,orderby:"date",
...
isModeActive:function(d){return!!this.activeModes.where({id:d}).length}});_.extend(f.prototype,wp.media.controller.StateMachine.prototype);g.exports=f},LND6:function(g,f){var d=wp.media.View;f=d.extend({tagName:"form",className:"compat-item",events:{submit:"preventDefault","change input":"save","change select":"save","change textarea":"save"},initialize:function(){this.listenTo(this.model,"change:compat",this.render)},dispose:function(){this.$(":focus").length&&this.save();return d.prototype.dispose.apply(this,
...
["ready"])}});g.exports=f},LZpE:function(g,f){f=wp.media.View.extend({tagName:"button",className:"media-button",attributes:{type:"button"},events:{click:"click"},defaults:{text:"",style:"",size:"large",disabled:!1},initialize:function(){this.model=new Backbone.Model(this.defaults);_.each(this.defaults,function(d,b){d=this.options[b];_.isUndefined(d)||(this.model.set(b,d),delete this.options[b])},this);this.listenTo(this.model,"change",this.render)},render:function(){var d=["button",this.className],
b=this.model.toJSON();b.style&&d.push("button-"+b.style);b.size&&d.push("button-"+b.size);d=_.uniq(d.concat(this.options.classes));this.el.className=d.join(" ");this.$el.attr("disabled",b.disabled);this.$el.text(this.model.get("text"));return this},click:function(d){"#"===this.attributes.href&&d.preventDefault();this.options.click&&!this.model.get("disabled")&&this.options.click.apply(this,arguments)}});g.exports=f},"M+xU":function(g,f){var d=wp.media.view.l10n;f=wp.media.controller.State.extend({defaults:{id:"cropper",
...
m[h]=new l({controller:this,model:e[h],priority:40}),a.sidebar.set(m),k&&a.toolbar.set("dragInfo",new wp.media.View({el:c('<div class="instructions">'+k+"</div>")[0],priority:-40})),a.toolbar.set("reverse",{text:b.reverseOrder,priority:80,click:function(){e.reset(e.toArray().reverse())}}))}});g.exports=f},NguE:function(g,f){var d=wp.media.View;f=d.extend({className:"media-uploader-status",template:wp.template("uploader-status"),events:{"click .upload-dismiss-errors":"dismiss"},initialize:function(){this.queue=
...
"close","attach","detach","escape"],function(e){a.prototype[e]=function(){this.modal&&this.modal[e].apply(this.modal,arguments);return this}});g.exports=a},"Q9T/":function(g,f){f=wp.media.view.MenuItem.extend({click:function(){var d=this.options.contentMode;d&&this.controller.content.mode(d)}});g.exports=f},S4jH:function(g,f){var d=jQuery;f=wp.media.View.extend({tagName:"div",className:"uploader-window",template:wp.template("uploader-window"),initialize:function(){this.$browser=d('<button type="button" class="browser" />').hide().appendTo("body");
...
priority:40}))},loading:function(){this.$el.toggleClass("embed-loading",this.model.get("loading"))}});g.exports=f},Vh02:function(g,f){var d=wp.media.View,b=wp.media.view.UploaderStatus,c=wp.media.view.l10n,a=jQuery;f=d.extend({className:"crop-content",template:wp.template("crop-content"),initialize:function(){_.bindAll(this,"onImageLoad")},ready:function(){this.controller.frame.on("content:error:crop",this.onError,this);this.$image=this.$el.find(".crop-image");this.$image.on("load",this.onImageLoad);
...
{nonce:d.get("nonces").edit,id:d.get("id"),context:"site-icon",cropDetails:b})}});g.exports=f},WiNq:function(g,f){f=function(d){_.extend(this,_.pick(d||{},"id","view","selector"))};f.extend=Backbone.Model.extend;_.extend(f.prototype,{mode:function(d){if(!d)return this._mode;if(d===this._mode)return this;this.trigger("deactivate");this._mode=d;this.render(d);this.trigger("activate");return this},render:function(d){if(d&&d!==this._mode)return this.mode(d);d={view:null};this.trigger("create",d);d=d.view;
this.trigger("render",d);d&&this.set(d);return this},get:function(){return this.view.views.first(this.selector)},set:function(d,b){b&&(b.add=!1);return this.view.views.set(this.selector,d,b)},trigger:function(d){if(this._mode){var b=_.toArray(arguments);var c=this.id+":"+d;b[0]=c+":"+this._mode;this.view.trigger.apply(this.view,b);b[0]=c;this.view.trigger.apply(this.view,b);return this}}});g.exports=f},ZeG4:function(g,f){f=wp.media.View.extend({className:"upload-error",template:wp.template("uploader-status-error")});
g.exports=f},ZgZ7:function(g,f){f=wp.media.View.extend({tagName:"input",className:"search",id:"media-search-input",attributes:{type:"search"},events:{input:"search"},render:function(){this.el.value=this.model.escape("search");return this},search:_.debounce(function(d){(d=d.target.value.trim())&&1<d.length?this.model.set("search",d):this.model.unset("search")},500)});g.exports=f},aBqq:function(g,f){var d=wp.media.controller.Library;f=d.extend({defaults:_.defaults({id:"replace-image",title:wp.media.view.l10n.replaceImageTitle,
...
createSelectToolbar:function(c,a){a=a||this.options.button||{};a.controller=this;c.view=new wp.media.view.Toolbar.Select(a)}});g.exports=f},gOpb:function(g,f){var d=jQuery;f=wp.media.View.extend({tagName:"div",template:wp.template("media-modal"),events:{"click .media-modal-backdrop, .media-modal-close":"escapeHandler",keydown:"keydown"},clickedOpenerEl:null,initialize:function(){_.defaults(this.options,{container:document.body,title:"",propagate:!0,hasCloseButton:!0});this.focusManager=new wp.media.view.FocusManager({el:this.el})},
...
e&&c.unobserve(a);c.validator=function(h){return!!this.mirroring.get(h.cid)&&!e.get(h.cid)&&d.prototype.validator.apply(this,arguments)};c.reset(c.mirroring.models,{silent:!0});c.observe(e);this.set("editLibrary",e);b.prototype.activate.apply(this,arguments)}});g.exports=f},iupV:function(g,f){var d=wp.media.view.Attachment,b=wp.media.view.l10n,c=jQuery,a=wp.i18n.__;f=d.extend({tagName:"div",className:"attachment-details",template:wp.template("attachment-details"),attributes:{},events:{"change [data-setting]":"updateSetting",
...
e=c.target.value;c.preventDefault();a.length&&(a.is('input[type="checkbox"]')&&(e=a[0].checked),this.model.set(a.data("setting"),e),(c=a.data("userSetting"))&&window.setUserSetting(c,e))},updateChanges:function(c){c.hasChanged()&&_(c.changed).chain().keys().each(this.update,this)}});g.exports=f},ojD6:function(g,f){var d=wp.media.View,b=jQuery,c=wp.media.view.settings.infiniteScrolling;f=d.extend({tagName:"ul",className:"attachments",attributes:{tabIndex:-1},initialize:function(){this.el.id=_.uniqueId("__attachments-view-");
...
e.scrollHeight-(h+e.clientHeight)<e.clientHeight/3&&k.get("spinner").show();e.scrollHeight<h+e.clientHeight*this.options.refreshThreshold&&this.collection.more().done(function(){a.scroll();k.get("spinner").hide()})}}});g.exports=f},qe5n:function(g,f){var d=Backbone.$;f=wp.media.controller.State.extend({defaults:{id:"embed",title:wp.media.view.l10n.insertFromUrlTitle,content:"embed",menu:"default",toolbar:"main-embed",priority:120,type:"link",url:"",metadata:{}},sensitivity:400,initialize:function(b){this.metadata=
...
function(a,e){c.prototype[a]=function(h,k){h=this.$('[data-setting="'+e+'"]');return h.length&&k!==h.find("input, textarea, select, [value]").val()?this.render():this}});g.exports=c},t3nl:function(g,f){f=wp.media.View.extend({className:"media-iframe",render:function(){this.views.detach();this.$el.html('<iframe src="'+this.controller.state().get("src")+'" />');this.views.render();return this}});g.exports=f},"tg/Y":function(g,f,d){g=wp.media;var b=jQuery;g.isTouchDevice="ontouchend"in document;f=g.view.l10n=
window._wpMediaViewsL10n||{};g.view.settings=f.settings||{};delete f.settings;g.model.settings.post=g.view.settings.post;b.support.transition=function(){var c=document.documentElement.style,a={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"},e;return(e=_.find(_.keys(a),function(h){return!_.isUndefined(c[h])}))&&{end:a[e]}}();g.events=_.extend({},Backbone.Events);g.transition=function(c,a){var e=b.Deferred();
a=a||2E3;b.support.transition?(c instanceof b||(c=b(c)),c.first().one(b.support.transition.end,e.resolve),_.delay(e.resolve,a)):e.resolve();return e.promise()};g.controller.Region=d("WiNq");g.controller.StateMachine=d("U3Se");g.controller.State=d("M5ZC");g.selectionSync=d("PgTd");g.controller.Library=d("F/kE");g.controller.ImageDetails=d("IkWq");g.controller.GalleryEdit=d("99yY");g.controller.GalleryAdd=d("ng6N");g.controller.CollectionEdit=d("Mt+m");g.controller.CollectionAdd=d("iipZ");g.controller.FeaturedImage=
d("I7TD");g.controller.ReplaceImage=d("aBqq");g.controller.EditImage=d("4tHu");g.controller.MediaLibrary=d("mVaH");g.controller.Embed=d("qe5n");g.controller.Cropper=d("M+xU");g.controller.CustomizeImageCropper=d("eqTc");g.controller.SiteIconCropper=d("W+32");g.View=d("Bbnu");g.view.Frame=d("LGdN");g.view.MediaFrame=d("Pt9x");g.view.MediaFrame.Select=d("fYN4");g.view.MediaFrame.Post=d("6B7g");g.view.MediaFrame.ImageDetails=d("VIJ9");g.view.Modal=d("gOpb");g.view.FocusManager=d("3nJM");g.view.UploaderWindow=
d("S4jH");g.view.EditorUploader=d("GXkx");g.view.UploaderInline=d("7Bpz");g.view.UploaderStatus=d("NguE");g.view.UploaderStatusError=d("ZeG4");g.view.Toolbar=d("2NU8");g.view.Toolbar.Select=d("IgEq");g.view.Toolbar.Embed=d("xQvM");g.view.Button=d("LZpE");g.view.ButtonGroup=d("z/+l");g.view.PriorityList=d("NjyZ");g.view.MenuItem=d("dpRc");g.view.Menu=d("Ju2C");g.view.RouterItem=d("Q9T/");g.view.Router=d("EVvK");g.view.Sidebar=d("9ARG");g.view.Attachment=d("sULL");g.view.Attachment.Library=d("2jku");
g.view.Attachment.EditLibrary=d("EvXF");g.view.Attachments=d("ojD6");g.view.Search=d("ZgZ7");g.view.AttachmentFilters=d("1S4+");g.view.DateFilter=d("VkcK");g.view.AttachmentFilters.Uploaded=d("4jjk");g.view.AttachmentFilters.All=d("KerO");g.view.AttachmentsBrowser=d("72mI");g.view.Selection=d("04Ix");g.view.Attachment.Selection=d("yGM1");g.view.Attachments.Selection=d("wfCN");g.view.Attachment.EditSelection=d("P6DV");g.view.Settings=d("nwwF");g.view.Settings.AttachmentDisplay=d("2AvB");g.view.Settings.Gallery=
d("umxe");g.view.Settings.Playlist=d("76BF");g.view.Attachment.Details=d("iupV");g.view.AttachmentCompat=d("LND6");g.view.Iframe=d("t3nl");g.view.Embed=d("VMHs");g.view.Label=d("V6sy");g.view.EmbedUrl=d("+mQJ");g.view.EmbedLink=d("JecU");g.view.EmbedImage=d("+B8m");g.view.ImageDetails=d("GXJ6");g.view.Cropper=d("Vh02");g.view.SiteIconCropper=d("UmHM");g.view.SiteIconPreview=d("d3xu");g.view.EditImage=d("ibOK");g.view.Spinner=d("cH3P");g.view.Heading=d("l2j4")},umxe:function(g,f){f=wp.media.view.Settings.extend({className:"collection-settings gallery-settings",
template:wp.template("gallery-settings")});g.exports=f},wfCN:function(g,f){var d=wp.media.view.Attachments;f=d.extend({events:{},initialize:function(){_.defaults(this.options,{sortable:!1,resize:!1,AttachmentView:wp.media.view.Attachment.Selection});return d.prototype.initialize.apply(this,arguments)}});g.exports=f},xQvM:function(g,f){var d=wp.media.view.Toolbar.Select,b=wp.media.view.l10n;f=d.extend({initialize:function(){_.defaults(this.options,{text:b.insertIntoPost,requires:!1});d.prototype.initialize.apply(this,
arguments)},refresh:function(){var c=this.controller.state().props.get("url");this.get("select").model.set("disabled",!c||"http://"===c);d.prototype.refresh.apply(this,arguments)}});g.exports=f},yGM1:function(g,f){f=wp.media.view.Attachment.extend({className:"attachment selection",toggleSelection:function(){this.options.selection.single(this.model)}});g.exports=f},"z/+l":function(g,f){var d=Backbone.$;f=wp.media.View.extend({tagName:"div",className:"button-group button-large media-button-group",initialize:function(){this.buttons=
_.map(this.options.buttons||[],function(b){return b instanceof Backbone.View?b:(new wp.media.view.Button(b)).render()});delete this.options.buttons;this.options.classes&&this.$el.addClass(this.options.classes)},render:function(){this.$el.html(d(_.pluck(this.buttons,"el")).detach());return this}});g.exports=f}});
