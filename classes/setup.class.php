...
//            self::include_plugin_file('views/welcome.php');
            ...
            $form_action = Helper::security()->getIndex('/jkoptions/save?plugin=' . $pluginName);
            ...
            if (class_exists('CSF_Options') && !empty(self::$args['admin_options'])) {
                foreach (self::$args['admin_options'] as $key => $value) {
                    ...
                    if (!empty(self::$args['sections'][$key]) && !isset(self::$inited[$key])) {
                        ...
                        update_jk_key_params($key, $op_obj);
...
//            do_action('csf_loaded');
        ...
        {
            $val = new \Typecho\Widget\Helper\Form\Element\Hidden('jkOptionsHide',
                NULL,
                "jkOptionsHide",
                'jk选项框架隐藏val',
                '');
...
//      $directory_uri  = set_url_scheme( $directory_uri, $protocol_uri );
        ...
        {
            // include router
            self::include_plugin_file('classes/jkRouter.class.php');
...
//            do_action('csf_enqueue');
        ...
        public static function Widget_()
        {
