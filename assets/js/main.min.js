...
parseInt(b.css("padding-right"));var g=0,e=!1,f=function(){e||requestAnimationFrame(function(){var k=a.offset().top;k=Math.max(8,k-g);var l=c.innerWidth();8>=k&&782<l?(b.css({width:a.outerWidth()}),a.css({height:a.outerHeight()}).addClass("csf-sticky")):(b.removeAttr("style"),a.removeAttr("style").removeClass("csf-sticky"));e=!1});e=!0},h=function(){g=c.scrollTop();f()};c.on("scroll resize",h);h()})};d.fn.csf_dependency=function(){return this.each(function(){var a=d(this),c=a.children("[data-controller]");
if(c.length){var b=d.csf_deps.createRuleset(),g=d.csf_deps.createRuleset(),e=[],f=[];c.each(function(){var h=d(this),k=h.data("controller").split("|"),l=h.data("condition").split("|"),m=h.data("value").toString().split("|"),p=!!h.data("depend-global"),r=p?g:b;d.each(k,function(u,q){(r=r.createRule('[data-depend-id="'+q+'"]',l[u]||l[0],m[u]||"")).include(h);p?f.push(q):e.push(q)})});e.length&&d.csf_deps.enable(a,b,e);f.length&&d.csf_deps.enable(n.vars.$body,g,f)}})};d.fn.csf_field_accordion=function(){return this.each(function(){d(this).find(".csf-accordion-title").on("click",
